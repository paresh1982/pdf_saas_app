                    ...
                    >
                        ...
                        >
                           <div className="flex items-center gap-6">
                             ...
                             <div className="text-left">
                               ...
                               <p className="text-xs text-foreground/40 font-black leading-tight uppercase tracking-widest hidden md:block">
                      ...
                      >
                        <div className="flex items-center justify-center gap-6">
                          ...
                          <div className="text-left">
                            <p className="text-xl md:text-2xl font-black text-white uppercase tracking-[0.2em]">
